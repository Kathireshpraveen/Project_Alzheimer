...
import 'package:medicine/Components/emergency_contacts_data.dart';
import 'package:medicine/Components/personal_emergency_contacts.dart';
...
class _HomeScreenTabsState extends State<HomeScreenTabs>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Alzheimer's Companion"),
        elevation: 0.7,
        bottom: TabBar(
